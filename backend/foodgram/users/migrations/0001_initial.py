    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, help_text='Email', max_length=150, unique=True, verbose_name='Email')),
                ('username', models.CharField(db_index=True, help_text='Логин пользователя', max_length=150, unique=True, verbose_name='Логин')),
                ...
                ('password', models.CharField(help_text='Пароль пользователя', max_length=150, verbose_name='Пароль')),
