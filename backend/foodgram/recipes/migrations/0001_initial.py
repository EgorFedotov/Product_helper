...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Название ингредиента', max_length=200, validators=[users.validators.UserNameValidator()], verbose_name='Название ингредиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Название рецепта', max_length=200, validators=[users.validators.UserNameValidator()], verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Название тега', max_length=200, unique=True, validators=[users.validators.UserNameValidator()], verbose_name='Название')),
                ('color', models.CharField(help_text='Цветовой HEX-код', unique=True, validators=[recipes.validators.ColorValidator], verbose_name='HEX-код цвета')),
